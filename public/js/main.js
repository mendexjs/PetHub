...
var DetailsPetComponent = /** @class */ (function () {
    ...
    DetailsPetComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("http://192.168.1.101:8000/api/doacao/" + this.id)
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.loginSubmit = function () {
        var _this = this;
        this.loading = true;
        this.http.post('http://192.168.1.101:8000/api/auth/login', {
            ...
            if (data['status']) {
                ...
                _this.router.navigate(['/petmatch']);
            }
        });
    };
    LoginComponent.prototype.onSubmit = function () {
        ...
        //this.criarForm(form);
        this.http.post('http://192.168.1.101:8000/api/user', formModel)
            .subscribe(function (data) {
            _this.loading = false;
            if (data['status'] == 424) {
                ...
                _this.http.post('http://192.168.1.101:8000/api/auth/login', {
    ...
    LoginComponent.prototype.confirmaSenha = function () {
        this.confirmaPass = (this.formulario.get('senha').value == this.formulario.get('confirma_senha').value) ? false : true;
    };
...
var PetMatchAddComponent = /** @class */ (function () {
    ...
    PetMatchAddComponent.prototype.onSubmit = function () {
        ...
        var formModel = this.prepareSave();
        //this.criarForm(form);
        if (this.http.post('http://192.168.1.101:8000/api/doacao?token=' + localStorage.getItem('token'), formModel)
            .subscribe(function (data) {
            _this.loading = false;
            if (data['status'] == 424) {
                _this.popUp("Preencha o formulario corretamente");
...
var PetMatchComponent = /** @class */ (function () {
    ...
    PetMatchComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("http://192.168.1.101:8000/api/busca/doacao/Braganca")
    ...
    PetMatchComponent.prototype.filtro = function () {
        var _this = this;
        this.http.get("http://192.168.1.101:8000/api/busca/doacao/Braganca/" + this.porte + "/" + this.pelagem + "/" + this.castrado + "/" + this.tipo)
            .subscribe(function (data) { return _this.pets = data; });
    };
    PetMatchComponent.prototype.delete = function (id) {
        var _this = this;
        console.log(id);
        this.http.delete("http://192.168.1.101:8000/api/doacao/" + id)
            .subscribe(function (data) {
            console.log(data);
            _this.http.get("http://192.168.1.101:8000/api/busca/doacao/Braganca")
                .subscribe(function (data) { return _this.pets = data; });
        });
    };
...
module.exports = __webpack_require__(/*! /home/mendex/laravel/PetHub/angular-app/src/main.ts */"./src/main.ts");
